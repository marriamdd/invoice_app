...
export default function AppLayout() {
	...
	return (
		<div
			className={`${
				isDarkMode ? "dark" : ""
			}   ${showAddInvoice && "md:overflow-hidden md:h-[100vh]"}  ${showEditInvoice && "xl:overflow-hidden xl:-h-[100vh]"} ${isDeleteOpen && "xl:overflow-hidden xl:-h-[100vh]"}  flex flex-col items-center xl:flex-row xl:items-start relative min-h-[100vh]`}
		>
			<Header />
