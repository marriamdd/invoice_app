...
function Filter({ invoices, setInfo }: FilterProps) {
	...
	return (
		<div className="xl:p-[20px]	px-[20px] xl:max-w-[720px] md:w-[672px] w-[375px] justify-between  xl:mt-[0px] md:mt-[60px] text-black font-bold  text-[15px] flex  items-center ">
